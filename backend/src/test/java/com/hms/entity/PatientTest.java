...
public class PatientTest {
    ...
    public void testSetContact_Variant1() {
        Patient obj = new Patient();
        obj.setContact("99991");
        assertEquals("99991", obj.getContact());
    }

    @Test
    public void testSetContact_Variant2() {
        Patient obj = new Patient();
        obj.setContact("99992");
        assertEquals("99992", obj.getContact());
    }
    ...
    public void testSetPassword_Variant3() {
        Patient obj = new Patient();
        obj.setPassword("pass3");
        assertEquals("pass3", obj.getPassword());
    }

    @Test
    public void testSetPassword_Variant4() {
        Patient obj = new Patient();
        obj.setPassword("pass4");
        assertEquals("pass4", obj.getPassword());
    }
}
