...
public class PrescriptionTest {
    ...
    @Test
    public void testSetPrescription_Variant1() {
        Prescription obj = new Prescription();
        obj.setPrescription("Aspirin");
        assertEquals("Aspirin", obj.getPrescription());
    }

    @Test
    public void testSetPrescription_Variant2() {
        Prescription obj = new Prescription();
    ...
    @Test
    public void testSetPrescription_Variant4() {
        Prescription obj = new Prescription();
        obj.setPrescription("Paracetamol");
        assertEquals("Paracetamol", obj.getPrescription());
    }
}
